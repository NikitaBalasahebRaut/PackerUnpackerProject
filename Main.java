...
class Login extends Templete implements ActionListener, Runnable
{
  JButton SUBMIT;
  ...
  public void actionPerformed(ActionEvent ae)
  {
	  ...
	  if(ae.getSource() == SUBMIT)
	  {
		  if(Validate(value1,value2) == false)
		  {
			  text1.setText("");
			  text2.setText("");
			  JOptionPane.showMessageDialog(this,"Short username","PackerUnpacker",JOptionPane.ERROR_MESSAGE);
		  }
